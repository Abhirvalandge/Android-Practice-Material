...
public class ProfileActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private void handlleSignInResult(GoogleSignInResult result){
        ...
        if(result.isSuccess()){
            ...
            Picasso.with(this).load(account.getPhotoUrl()).placeholder(R.mipmap.ic_launcher).into(profile_image);
        }else {
            gotoMainActivity();
        }
    }
